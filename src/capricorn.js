...
function Capricorn(){
  ...
  const newdata= ZodiacSignsDetail.find((ZodiacSignsDetail)=> ZodiacSignsDetail.Id === 10);
  ...
  <h4 className="div1">{Title0}</h4>
            <h3 className="div1" id="earth">{Element}</h3>
 ...
 <div className="img1">
           <div > <img src={ZodiacSign2ImageUrl} alt={Name} className="adj" /></div>
            ...
            <div className="">
              <h2 className="earth">{Title1}</h2>
              <h4  className="">{LifePurpose}</h4>
              <h2 className="earth">{Title2}</h2>
              <h5>{Loyal}</h5>
              <h2  className="earth">{Title3}</h2>
              <h5>{RepresentativeFlower}</h5>

              <h2  className="earth">{Title4}</h2>
              <h5>{Angry}</h5>
              <h2  className="earth">{Title5}</h2>
              <h5>{Character}</h5>
              <h2  className="earth">{Title6}</h2>
